//
//  VacationFileAddViewController.m
//  Virtual Vacation
//

#import "VacationFileAddViewController.h"
#define VACATION_NAME_PLACEHOLDER @"MyVacation"
...
@interface VacationFileAddViewController () <UITextFieldDelegate>

@property (nonatomic, weak) IBOutlet UITextField *nameTextField;
@property (nonatomic, weak) IBOutlet UILabel *statusLabel;
@property (nonatomic, weak) IBOutlet UILabel *statusLabelExtended;

@end

@implementation VacationFileAddViewController
...
-(BOOL)checkIfTextFieldValid {
    ...
    } else if([self.delegate vacationFileAddViewController:self asksIfVacationWithGivenNameExists:value]) {
...
- (IBAction)cancel:(UIButton *)sender {
    [self.delegate vacationFileAddViewController:self didAddVacation:nil];
}

- (IBAction)save:(UIButton *)sender {
    if([self checkIfTextFieldValid]) {
        [self.delegate vacationFileAddViewController:self didAddVacation:self.nameTextField.text];
    }
}
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    if([self checkIfTextFieldValid]) {
        ...
        [self.delegate vacationFileAddViewController:self didAddVacation:textField.text];
        return YES;
    }
    return NO;
}
